			...
			<Stack>
				<StackItem width="50%" lg-width="100%">
					<Override
						...
						margin-right="-20%"
						padding-bottom="120%"
						background="url(https://images.unsplash.com/photo-1606844358484-ab8725cab420?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&h=2000) 50% 15%/cover"
						lg-margin-right="0"
				...
				<StackItem width="50%" lg-width="100%">
					...
					<Text as="p" margin="16px 0" font="--base" max-width="400px">
						YOU CAN GET THE NECESSARY DOCUMENTS FOR OUR ENGLISH UG HONS OURSE 2020 STUDY
					</Text>
				</StackItem>
			</Stack>
		</Section>
